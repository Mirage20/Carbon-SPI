...
public class TCCLSetterVisitor extends ClassVisitor implements Opcodes {
    ...
    private static final Type UTIL_CLASS = Type.getType(DynamicInject.class);
    ...
    // (to the DynamicInject.class.getPackage()) is needed.
    ...
    public void visitEnd() {
        ...
        for (WeavingData wd : weavingData) {
             ...
             *   DynamicInject.fixContextClassLoader("java.util.ServiceLoader", "load", cls, WovenClass.class.getClassLoader());
             * }
             */
    ...
    private class TCCLSetterMethodVisitor extends GeneratorAdapter {
         ...
         *  DynamicInject.storeContextClassloader();
         *  $$FCCL$$(<class>)
         *  DynamicInject.restoreContextClassloader();
         */
        @Override
